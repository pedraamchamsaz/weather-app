...
const options = {
  ...
  return (
    <div className="flex flex-col items-center mt-5 gap-2">
        ...
        style={style}
      />
          <p className="text-5xl font-bold">{unit ? `${Math.round(weather?.current?.temp)}°C` : `${Math.round(changeToFahrenheit(weather?.current?.temp))}°F`}</p>
        ...
        <article className="rounded-lg mx-auto md:w-3/2 lg:w-4/5 xl:w-5/4 flex gap-8 text-center w-full mt-7 py-3  justify-center">
          ...
          <div className="flex flex-col items-center shadow-md py-4 px-6 rounded-lg w-1/6 min-w-28">
