  ...
  return (
    <div className="flex flex-col items-center mt-5 gap-2">
        <p>{new Date(weather?.current?.dt * 1000).toLocaleString('en-GB', options)}</p>
          <p className="text-2xl font-bold">{weather?.cityName}</p>
          <Lottie
      ...
      />
        ...
        <article className="rounded-lg border border-gray-200   mx-auto md:w-3/2 lg:w-4/5 xl:w-5/4 flex gap-8 text-center w-full mt-5 py-3  justify-center">

          <div className="flex flex-col items-center shadow-md p-4 rounded-lg w-1/6">
          ...
          <div className="flex flex-col items-center shadow-md py-4 px-6 rounded-lg w-1/6">
